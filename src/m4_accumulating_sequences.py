...
def main():
    ...
    # ------------------------------------------------------------------
    # : 8. Uncomment the tests below before working TO DO 9.
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        p1 = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        p2 = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
